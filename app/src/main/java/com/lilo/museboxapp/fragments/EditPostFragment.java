...
public class EditPostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactInput = view.findViewById(R.id.edit_post_fragment_contact_edit_text);
    ...
    private void setEditPostHints(){
        ...
        contactInput.setText(post.contact);
    }
    ...
    private Post generatedEditedPost(String imageUrl) {
        ...
        if (contactInput.getText().toString() != null && !contactInput.getText().toString().equals(""))
            editedPost.contact = contactInput.getText().toString();
        else editedPost.contact = post.contact;
        if (imageUrl != null)
